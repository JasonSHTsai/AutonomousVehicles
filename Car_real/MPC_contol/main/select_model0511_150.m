...
% 
% %% Setting Parameter
% V_threshold_1=2.7;V_range_1=0.55;%0.7for ex1
% V_threshold_2=10.6;V_range_2=0.65;
...
%             select_MPC(i,:) = 4; 
%     elseif Velocityb(i,:) <= -0.27 && cur(i,:)==1 && i>2000
%             select_MPC(i,:) = 4; 
%     elseif Velocityb(i,:) <= -0.25 && cur(i,:)==-1 && i<1000
%             select_MPC(i,:) = 8;
%     elseif Velocityb(i,:) <= -0.24 && cur(i,:)==-1 && i>=1000 && i<1700
%             select_MPC(i,:) = 5;
%     elseif Velocityb(i,:) <= -0.23 && cur(i,:)==-1 && i>=1700 && i<2000
%             select_MPC(i,:) = 5;
%     elseif Velocityb(i,:) <= -0.2 && cur(i,:)==-1 && i>=2000 && i<2350
%             select_MPC(i,:) = 6;
%     elseif Velocityb(i,:) <= -0.24 && cur(i,:)==-1 && i>=2350
%             select_MPC(i,:) = 6;
...
% select_MPC = smooth(select_MPC,index,9);
% %% select_overlap
% for i = 1:length(Velocity)
%     if Velocityb(i,:) <= -0.01 && cur(i,:)==1 && Velocityb(i,:) > -0.2      
%             select_overlap(i,:) = 4;
% %     elseif Velocityb(i,:) <= -0.07 && cur(i,:)==1 && Velocityb(i,:) > -0.29  && i<1500  && i>1000     
% %             select_overlap(i,:) = 4;
