function [diff_Acceleration,diff_Angular_acceleration,temp,select_Model] = select_model_1227(Velocity,Heading,Low_Speed,Medium_Speed,High_Speed,Overlap_Maxium,N)
%% define 18 models
% 低速加速(LA)
%   右轉:LAR 1
%   左轉:LAL 2
