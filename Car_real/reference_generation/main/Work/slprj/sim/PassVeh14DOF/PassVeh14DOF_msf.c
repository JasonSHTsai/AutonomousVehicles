...
MdlRefChildMdlRec childModels [ 1 ] = { "PassVeh14DOF" , "PassVeh14DOF" , 0 }
...
ssGetContStates ( S ) ; m3kvjvuvj4 ( & ( dw -> rtm ) , & ( dw -> rtdw ) ,
localX ) ; ssSetPeriodicContState ( S , 0 , 3 , - 3.1415926535897931 ,
3.1415926535897931 ) ; ssSetPeriodicContState ( S , 1 , 4 , -
3.1415926535897931 , 3.1415926535897931 ) ; ssSetPeriodicContState ( S , 2 ,
5 , - 3.1415926535897931 , 3.1415926535897931 ) ; } static void mdlReset (
...
* S , int_T tid ) { egcgcay4tuh * dw = ( egcgcay4tuh * ) ssGetDWork ( S , 0 )
; const real_T * i_cicr2a5kpd = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
const real_T * i_culqfs1ysv = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
const real_T * i_mcau1kqq0y = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
const real_T * i_eics31md2u = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ;
const real_T * i_itd21vjha2 = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ;
const real_T * i_dvme42dmxf = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ;
real_T * o_B_20_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_B_20_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_20_3 =
( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_20_4 = ( real_T *
...
ssGetOutputPortSignal ( S , 7 ) ; real_T * o_B_20_9 = ( real_T * )
ssGetOutputPortSignal ( S , 8 ) ; real_T * o_B_20_10 = ( real_T * )
ssGetOutputPortSignal ( S , 9 ) ; real_T * o_B_20_11 = ( real_T * )
ssGetOutputPortSignal ( S , 10 ) ; real_T * o_B_20_12 = ( real_T * )
ssGetOutputPortSignal ( S , 11 ) ; real_T * o_B_20_13 = ( real_T * )
ssGetOutputPortSignal ( S , 12 ) ; real_T * o_B_20_14 = ( real_T * )
ssGetOutputPortSignal ( S , 13 ) ; real_T * o_B_20_15 = ( real_T * )
ssGetOutputPortSignal ( S , 14 ) ; real_T * o_B_20_16 = ( real_T * )
ssGetOutputPortSignal ( S , 15 ) ; real_T * o_B_20_17 = ( real_T * )
ssGetOutputPortSignal ( S , 16 ) ; real_T * o_B_20_18 = ( real_T * )
ssGetOutputPortSignal ( S , 17 ) ; real_T * o_B_20_19 = ( real_T * )
ssGetOutputPortSignal ( S , 18 ) ; real_T * o_B_20_20 = ( real_T * )
ssGetOutputPortSignal ( S , 19 ) ; h21fsrthfa * localX = ( h21fsrthfa * )
...
dw -> rtm ) , i_cicr2a5kpd , i_culqfs1ysv , i_mcau1kqq0y , i_eics31md2u ,
i_itd21vjha2 , i_dvme42dmxf , o_B_20_1 , o_B_20_2 , o_B_20_3 , o_B_20_4 ,
o_B_20_5 , o_B_20_6 , o_B_20_7 , o_B_20_8 , o_B_20_9 , o_B_20_10 , o_B_20_11
, o_B_20_12 , o_B_20_13 , o_B_20_14 , o_B_20_15 , o_B_20_16 , o_B_20_17 ,
o_B_20_18 , o_B_20_19 , o_B_20_20 , & ( dw -> rtb ) , & ( dw -> rtdw ) ,
localX , & ( dw -> rtzce ) , localXdis ) ; jpl1qt0btr ( & ( dw -> rtm ) , & (
...
, 2 ) ; ssSetNumContStates ( S , 62 ) ; ssSetNumDiscStates ( S , 0 ) ;
ssSetNumPeriodicContStates ( S , 3 ) ; { const char * modelNames [ ] = { "" }
...
, 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 20 ) ) return ; if ( !
...
mr_PassVeh14DOF_RegisterSimStateChecksum ( S ) ; { static ssRTWStorageType
...
ssSetOutputPortIsFedByBlockWithModesNoZCs ( S , 16 , 1 ) ;
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:BlkWithStatePortNotSupported\" pr=\"d\"><arguments><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg><arg type=\"encoded\"></arg></arguments><hs><h>AAAACgCS1ED+</h></hs></diag></diag_root>"
) ; ssHasStateInsideForEachSS ( S , true ) ; ssSetModelRefHasParforForEachSS
...
0 ) ; ssSetSampleTime ( S , 1 , 0 ) ; ssSetOffsetTime ( S , 1 , 1 ) ; return
; }
...
7 ] ; ssNonContDerivSigFeedingOutports mr_nonContOutput8 [ 22 ] ;
...
sysTid = 0 ; } absTolControl [ 20 ] = 1 ; absTolControl [ 21 ] = 1 ;
absTolControl [ 22 ] = 1 ; absTolControl [ 23 ] = 1 ; absTolControl [ 24 ] =
1 ; absTolControl [ 25 ] = 1 ; absTolControl [ 26 ] = 1 ; absTolControl [ 27
] = 1 ; absTolControl [ 44 ] = 1 ; absTolControl [ 45 ] = 1 ; absTolControl [
46 ] = 1 ; absTolControl [ 47 ] = 1 ; mr_nonContOutputArray [ 0 ] = ( NULL )
; mr_nonContOutputArray [ 1 ] = ( NULL ) ; mr_nonContOutputArray [ 2 ] = (
NULL ) ; mr_nonContOutputArray [ 3 ] = ( NULL ) ; mr_nonContOutputArray [ 4 ]
= ( NULL ) ; mr_nonContOutputArray [ 5 ] = ( NULL ) ; mr_nonContOutputArray [
6 ] = mr_nonContOutput6 ; mr_nonContOutputArray [ 7 ] = ( NULL ) ;
...
[ 11 ] = ( NULL ) ; mr_nonContOutputArray [ 12 ] = ( NULL ) ;
mr_nonContOutputArray [ 13 ] = ( NULL ) ; mr_nonContOutputArray [ 14 ] = (
NULL ) ; mr_nonContOutputArray [ 15 ] = ( NULL ) ; mr_nonContOutputArray [ 16
] = ( NULL ) ; mr_nonContOutputArray [ 17 ] = mr_nonContOutput17 ;
mr_nonContOutputArray [ 18 ] = mr_nonContOutput18 ; mr_nonContOutputArray [
19 ] = mr_nonContOutput19 ; klg3zs3vu4 ( S , mr_nonContOutputArray ,
...
static void mdlDisable ( SimStruct * S ) { egcgcay4tuh * dw = ( egcgcay4tuh *
) ssGetDWork ( S , 0 ) ; gy0s4k0fxb * localXdis = ( gy0s4k0fxb * )
ssGetContStateDisabled ( S ) ; l2qaz5g1su ( & ( dw -> rtm ) , & ( dw -> rtdw
) , localXdis ) ; return ; } static void mdlOutputs ( SimStruct * S , int_T
tid ) { egcgcay4tuh * dw = ( egcgcay4tuh * ) ssGetDWork ( S , 0 ) ; const
real_T * i_cicr2a5kpd = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; const
real_T * i_culqfs1ysv = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; const
...
PARAMETER_TUNING_TID ) { PassVeh14DOF ( & ( dw -> rtm ) , i_cicr2a5kpd ,
i_culqfs1ysv , i_mcau1kqq0y , i_eics31md2u , i_itd21vjha2 , i_dvme42dmxf ,
o_B_20_1 , o_B_20_2 , o_B_20_3 , o_B_20_4 , o_B_20_5 , o_B_20_6 , o_B_20_7 ,
o_B_20_8 , o_B_20_9 , o_B_20_10 , o_B_20_11 , o_B_20_12 , o_B_20_13 ,
o_B_20_14 , o_B_20_15 , o_B_20_16 , o_B_20_17 , o_B_20_18 , o_B_20_19 ,
o_B_20_20 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , & ( dw -> rtzce ) ,
localXdis ) ; } }
#define MDL_UPDATE
...
* ) ssGetAbsTolVector ( S ) ; jpl1qt0btr ( & ( dw -> rtm ) , & ( dw -> rtb )
...
ssGetdX ( S ) ; kpl5p5meuz ( & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw ->
rtdw ) , localX , localXdis , localXdot ) ; } static void mdlTerminate (
SimStruct * S ) { egcgcay4tuh * dw = ( egcgcay4tuh * ) ssGetDWork ( S , 0 ) ;
apei0jh2jv ( & ( dw -> rtm ) ) ; return ; }
