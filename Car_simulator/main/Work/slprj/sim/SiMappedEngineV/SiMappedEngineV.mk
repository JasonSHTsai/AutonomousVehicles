...
MODULES              = SiMappedEngineV.c SiMappedEngineV_capi.c
MAKEFILE             = SiMappedEngineV.mk
MATLAB_ROOT          = D:/Program Files (x86)/MATLAB/2018a
ALT_MATLAB_ROOT      = D:/Program Files (x86)/MATLAB/2018a
MATLAB_BIN           = D:/Program Files (x86)/MATLAB/2018a/bin
ALT_MATLAB_BIN       = D:/Program Files (x86)/MATLAB/2018a/bin
MASTER_ANCHOR_DIR    = 
START_DIR            = D:/study/Autonomous_veh/Veh_dyn_Main_7DOF_beta_01/Mpc_Ctrl_Path_following_3mdchange_VYupd_circle_new/main/Work
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 3
BUILDARGS            = MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN%  GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DSLMSG_ALLOW_SYSTEM_ALLOC -DMATLAB_MEX_FILE -DTID01EQ=1"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ALLOCATIONFCN        = 0
...
GEN_SAMPLE_MAIN      = 0
MEX_OPT_FILE         = -f D:/Program Files (x86)/MATLAB/2018a/rtw/c/tools/lcc-win64.xml
SHRLIBTARGET         = 0
...
MODELLIB                  = SiMappedEngineVlib.lib
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/SiMappedEngineV \
	-ID:/study/Autonomous_veh/Veh_dyn_Main_7DOF_beta_01/Mpc_Ctrl_Path_following_3mdchange_VYupd_circle_new/refs/SI/Plant \
