...
%Acceleration Signal
Brake_str1 = 20; Brake_end1 = 25; Brake_du1 = Brake_end1 - Brake_str1;%(sec)
Brake_str2 = 35; Brake_end2 = 45; Brake_du2 = Brake_end2 - Brake_str2;%(sec)
Brake_str3 = 60; Brake_end3 = 65; Brake_du3 = Brake_end3 - Brake_str3;%(sec)
Brake_str4 = 80; Brake_end4 = 86; Brake_du4 = Brake_end4 - Brake_str4;%(sec)
% Brake_str4 = 95; Brake_end4 = 100; Brake_du4 = Brake_end4 - Brake_str4;%(sec)

Accelcmd = -0.5*(-1+cos(2*pi*t_sim/Td))*0.7;
% Accelcmd = -0.5*(-1+cos(2*pi*t_sim/Td))*0;
...
bm1 = 0.0125;
y1 = bm1*t_brake1 - bm1*t_brake1(1);
% y2 = 0*normpdf(t_brake2,0.6,0.6);
bm2 = 0.01325;
y2 = bm2*t_brake2 - bm2*t_brake2(1);
% y3 = 0.6*normpdf(t_brake3,0.6,0.6);
bm3 = 0.04;
y3 = bm3*t_brake3 - bm3*t_brake3(1);

bm4 = 0.0335;
y4 = bm4*t_brake4 - bm4*t_brake4(1);
...
Accelcmd_tmp = smooth(Accelcmd');
% Accel_input = [t_sim' Accelcmd'];
Accel_input = [t_sim' Accelcmd_tmp];
...
save('ID_inf_fast1.mat','Steer','Accelcmd','t_sim','Yaw','Velocity','XYplot');