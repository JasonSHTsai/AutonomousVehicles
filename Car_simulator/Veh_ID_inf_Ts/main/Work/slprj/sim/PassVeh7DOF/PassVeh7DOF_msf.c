...
localX , & ( dw -> rtzce ) ) ; ii3iorkudk ( & ( dw -> rtm ) , & ( dw -> rtb )
...
1 ; real_T fixedStep = 0.001 ; ( fcn ) ( S ,
...
o_o_B_10_12 , o_o_B_10_15 , o_o_B_10_16 , o_o_B_10_18 , & ( dw -> rtdw ) ) ;
}
